...
I printed the wrong variable name at the end (eligible_count instead of eligible).
...
These programs helped me learn:

How to use loops and if-else conditions.

How to count things with variables.

How to check conditions like safe ranges or eligibility.

How to debug mistakes like wrong variable names or logical errors.

This was a good practice for improving my Python logic and problem-solving skills.